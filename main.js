//Хэш должен быть простым числом.
//Хэш определяется функцией hashToNumber, умножая ASCII код каждого символа на его вес(позицию+1) и складывая.
...
var calculateHash = (index, previousHash, timestamp, data, nonce) => {
    return hashToNumber(index + previousHash + timestamp + data + nonce)
